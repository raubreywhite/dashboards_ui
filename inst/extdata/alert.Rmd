---
title: "`r params$name_long` i `r fd::get_location_name(params$location_code)` og nærområdene"
sub_title: "Sykdomspulsen, `r lubridate::today()`"
header: "`r params$name_long` i `r fd::get_location_name(params$location_code)` og nærområdene"
