---
title: "`r params$name_long` i `r fhi::get_location_name(params$location_code)` og nærområdene"
sub_title: "Sykdomspulsen, `r lubridate::today()`"
header: "`r params$name_long` i `r fhi::get_location_name(params$location_code)` og nærområdene"
...
x_tag <- params$tag
x_county_code <- fd::norway_locations()[municip_code==x_municip_code]$county_code
x_municip_name <- fhi::get_location_name(x_municip_code)
