...
location_name <- fhidata::norway_locations_current[county_code==location_code]$county_name[1]
```
...
sykdomspulspdf_plot_total(location_code, x_tag=x_tag)
``` 
...
sykdomspulspdf_plot_ages(location_code, x_tag=x_tag)
``` 
\begingroup\footnotesize
